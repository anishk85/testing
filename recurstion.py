...
def recursive_permutations(s, prefix=""):
    """
    ...
    if len(s) == 0:
        ...
        for i in range(len(s)):
            recursive_permutations(s[:i] + s[i+1:], prefix + s[i])
...
if __name__ == "__main__":
    ...
    print("Reverse String:", recursive_reverse_string("recursion"))
